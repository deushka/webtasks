		...
		<div class="content">
			<?php 
				...
				while($items = mysqli_fetch_assoc($query)){ ?>
					<a href="element.php?id=<?php echo $items['id']?>" class="cart"><div class="cart-img"><img src=<?php echo $items['image'] ?> alt=""></div><h2><?php echo $items['title'] ?></h2><h4><?php echo $items['short'] ?></h4></a>
				<?php } ?>
		</div>
